...
class PropertiesByTypeScreen extends StatefulWidget {
  ...
  @override
  State<PropertiesByTypeScreen> createState() => _PropertiesByTypeScreenState();
}
...
class _PropertiesByTypeScreenState extends State<PropertiesByTypeScreen> {
    ...
    return _properties.where((p) {
      if (_searchQuery.isNotEmpty) {
        ...
        if (!city.contains(query) &&
            ...
            !title.contains(query)) return false;
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.displayName} Properties'),
              ...
              children: [
                TextField(
                  decoration: InputDecoration(
                    hintText: 'Search by city, address, or title...',
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'No ${widget.displayName.toLowerCase()} properties found',
                              style: TextStyle(
